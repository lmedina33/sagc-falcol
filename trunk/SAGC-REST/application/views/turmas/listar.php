                        ...
                        <div class="widget-body-toolbar bg-color-white">
                            <div class="row">
                                <div class="col-sm-12 col-md-10">
                                    <form class="form-inline" role="form" action="<?= site_url('turmas') ?>" method="get">
                                    ...
                                    <p class="resultText"><?= buscaQuantText($turmas) ?></p>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2 text-align-right">
                                    <? if ($usuarioLogado->temPermissao('administracao/turmas', true)) { ?>
                                        <a href="#turmas/novo" class="btn btn-primary btn-md pull-right header-btn hidden-mobile">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <? if ($usuarioLogado->temPermissao('administracao/turmas', true)) { ?>
                                                    <a class="excluir btn btn-sm btn-danger" data-id="<?= $turma->getId() ?>"><i class="fa fa-trash-o"></i> Excluir</a>
                                                <? } ?>
                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    var url = '<?= site_url('turmas/excluir'); ?>';
