            ...
            <div class="jarviswidget" role="widget">
                ...
                <div role="content">
                    ...
                    <div class="widget-body no-padding">
                        <form action="<?= site_url("alunos/novo"); ?>" id="aluno-form" method="post" class="smart-form" >
                            <fieldset>
                                <div class="row">
                                        ...
                                        <div id="foto-controls" class="controls">
                                            <? if (isset($_POST['foto'])): ?>
                                                <div class="thumbnail" style="width:150px; border-radius: 0px;">
                                                    ...
                                                    <img src="<?= base_url("uploads/alunos/{$_POST['foto']}") ?>" alt="">
                                                    <div class="caption">
                                                        <a id="excluir-foto" class="btn btn-danger">Remover</a>
                                                    </div>
                                                </div>
                                            <? else: ?>
                                ...
                                <div class="row">
                                    <section class="col col-xs-12 col-md-3 requerido">
                                        ...
                                        <label class="input">
                                            ...
                                            <input type="text" id="dataNasc" placeholder="DD/MM/AAAA" name="dataNascimento" data-mask="99/99/9999" data-mask-placeholder="_" value="<?= isset($_POST["dataNascimento"]) ? $_POST["dataNascimento"] : "" ?>">
                                        </label>
                                    </section>
                                    ...
                                    <section class="col col-xs-3">
                                        ...
                                        <label class="input">
                                            <input type="text" name="rgNumero" placeholder="RG">
                                        </label>
                                    </section>
                                    <section class="col col-xs-2">
                                        <label class="label">Orgão Emissor</label>
                                        <label class="input">
                                            <input type="text" name="rgOrgaoEmissor" placeholder="Orgão Emissor">
                                        </label>
                                    </section>                                    
                                </div>
                                <div class="row">
                                    <section class="col col-xs-2">
                                        ...
                                        <label class="input">
                                            <input type="text" name="cnhNumero">
                                        </label>
                                    </section>
                                    <section class="col col-xs-2">
                                ...
                                <div class="row">
                                    <section class="col col-xs-4">
                                        <label class="checkbox">
                                            <input type="checkbox" name="cooperativa">
                                            <i></i>
                                            Participa de Cooperativa de Taxistas?
                                        </label>                                        
                                    </section>
                                    <section class="col col-xs4">
                                        <label class="label">Nome da Cooperativa</label>
                                        <label class="input">                                            
                                            <input type="text" name="cooperativaNome">
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
    ...
    function runFormValidation() {
        ...
        var $alunoForm = $('#aluno-form').validate({
            ...
            rules: {
                ...
                cooperativaNome: {
                    required: "input[name=cooperativa]:checked"
                },
                logradouro: {
                    required: true
                },
            ...
            messages: {
                ...
                cooperativaNome: {
                    required: "Por favor, preencha o nome da cooperativa"
                },
                logradouro: {
